...
router.post(
  "/getCheckfriendAcceptornot",
  membersController.getCheckfriendAcceptornot
);
...
router.post(
  "/getAllMembersPageDashboard",
  membersController.getAllMembersPageDashboard
);
router.post(
  "/saveUserChat",
  upload.array("files"),
...
router.post(
  "/privatealbumdeleteprofile",
  membersController.privatealbumdeleteprofile
);
router.post(
  "/getuserChatmessageTotalMessage",
  membersController.getuserChatmessageTotalMessage
);
...
router.post("/recentActivity", membersController.recentActivity);
